...
<div style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
    ...
    <img style="height: 400px; width: auto; margin: 20px; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/bandit.png" alt="overthewire-bandit">
    <br>
    <!-- OverTheWire - Natas -->
    <img style="width: 25px; height: 25px; margin: 1%; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script">
    <img style="width: 25px; height: 25px; margin: 1%; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/gnu.png" alt="Linux">
    ...
    <br>
    <img style="height: 400px; width: auto; margin: 20px; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/natas.png" alt="overthewire-natas">
    <br>
    <!-- HackTheBox -->
    <img style="width: 25px; height: 25px; margin: 1%; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script">
    <img style="width: 25px; height: 25px; margin: 1%; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/gnu.png" alt="Linux">
    <img style="width: 25px; height: 25px; margin: 1%; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/win2.png" alt="Windows">
    <h4><a style="text-decoration: none;" href="https://www.hackthebox.com/" target="_blank"><img style="width: auto; height: 35px; margin: 1%; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/htb.png"</p>alt="htb"></a></h4>
    ...
    <img style="width: 25px; height: 25px; margin: 1%; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/under_construction.png" alt="under_construction">
    ...
    <br>
    <img style="height: 300px; width: auto; margin: 20px; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/castDrop.png" alt="castDrop.py">
    <img style="height: 300px; width: auto; margin: 20px; border-radius: 6px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/castDrop-1.png" alt="castDrop.py">
    <br>
</div>
