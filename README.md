...
<div style="display: flex; align-items: center; justify-items: center; justify-content: space-around;">
    ...
    <!-- OverTheWire - Bandit -->
    <img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/img/cmd-g.png" alt="Script">&MediumSpace;
    <img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/img/gnu-g.png" alt="Linux">
    <h4><a style="text-decoration: none;" href="https://overthewire.org/wargames/bandit/" target="_blank"><img style="width: auto; height: 35px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/otw.png" alt="OverTheWire">Bandit</a></h4>
    ...
    <img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/img/cmd-g.png" alt="Script">&MediumSpace;
    <img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/img/gnu-g.png" alt="Linux">
    <h4><a style="text-decoration: none;" href="https://overthewire.org/wargames/natas/" target="_blank"><img style="width: auto; height: 35px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/otw.png" alt="OverTheWire">Natas</a></h4>
    ...
    <br>
    <img style="height: auto; width: 400px; margin: 50px; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/natas.png" alt="overthewire-natas">
    <br>
    <hr>
    <br>
    <!-- HackTheBox -->
    <img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/img/cmd-g.png" alt="Script">&MediumSpace;
    <img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/img/gnu-g.png" alt="Linux">&MediumSpace;
    <img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/win2.png" alt="Windows">
    <h4><a style="text-decoration: none;" href="https://www.hackthebox.com/" target="_blank"><img style="width: auto; height: 35px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/htb.png" alt="htb"></a></h4>
    ...
    <br>
    <img style="height: 450px; width: auto; margin: 20px auto; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/htb_machines.png" alt="htb machines">
    <img style="height: 300px; width: auto; margin: 20px auto; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/htb_streak.png" alt="htb streak">
    <hr>
    <br>
    <h2>Proyectos Personales</h2>
    <!-- castDrop.py -->
    <a style="text-decoration: none;" href="https://github.com/dsevillaprog/Shell-Scripts/castDrop" target="_blank"><img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/python.png" alt="Python" title="castDrop.py"></a>&MediumSpace;<a style="text-decoration: none;" href="https://github.com/dsevillaprog/castDrop" target="_blank"><img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/img/cmd-g.png" alt="Termux" title="Termux"></a>&MediumSpace;<img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/under_construction.png" alt="under_construction">
    ...
    <br>
    <!-- cve_monitor.py -->
    <a style="text-decoration: none;" href="https://github.com/dsevillaprog/cve_monitor" target="_blank"><img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/python.png" alt="Python" title="cve_monitor.py"></a>&MediumSpace;<a style="text-decoration: none;" href="https://github.com/dsevillaprog/Shell-Scripts/" target="_blank"><img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/img/cmd-g.png" alt="Script" title="Shell-Scripts"></a>
    ...
    <a style="text-decoration: none;" href="https://github.com/dsevillaprog/Name_cleaner.sh" target="_blank"><img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/img/gnu-g.png" alt="Name_cleaner.sh" title="Name_cleaner.sh"></a>
    <a style="text-decoration: none;" href="https://github.com/dsevillaprog/Name_cleaner.py" target="_blank"><img style="width: auto; height: 30px; margin: 1%; border-radius: 8px;" src="https://github.com/dsevillaprog/CURSO-CSS/blob/main/Ejercicio2/img/python.png" alt="Python" title="Name_cleaner.py"></a>
