...
- ⚡ Fun fact: ...
-->
<h2 id="SobreMi" style="font-size: 1.1rem; line-height: 2rem; margin: auto; text-align: center; color: #1d1753;">Sobre mi:</h2>
<br>
<p style="font-size: 1.1rem; line-height: 2rem; margin: auto; text-align: center; color: #1d1753;">Programador autodidacta; comencé a programar con scripts en Batch y Visual Basic muy simples
...
<p style="font-size: 1.1rem; line-height: 2rem; margin: auto; text-align: center; color: #1d1753;">Encontré una web en la que superando retos cada vez más complejos, aprendí rápidamente a usar
...
<!-- <p style="font-size: 1.1rem; line-height: 2rem; margin: auto; text-align: center; color: #1d1753;">Me gustaría formarme en Ciberseguridad ya que es un campo que me fascina y me parece el mejor
...
<hr>
    ...
    <!-- OverTheWire - Bandit -->
        ...
        <p> un par de años más tarde, y tras hacer varios laboratorios de <a
            ...
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/bandit.png" alt="overthewire-bandit">
    <br>
    <!-- OverTheWire - Natas -->
        <img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script">
        <img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/gnu.png" alt="Linux">
        ...
        <br>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/natas.png" alt="overthewire-natas">
    <br>
    <!-- HackTheBox -->
        <img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script">
        <img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/gnu.png" alt="Linux">
        ...
        <p> - He realizado todas las máquinas gratuitas de nivel fácil, y varios retos Sherlock, estoy empezando
            el nivel medio.</p>
        <br>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/htb_machines.png" alt="htb machines">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/htb_streak.png" alt="htb streak">
    <hr>
    ...
    <!-- castDrop.py -->
        ...
        <br>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/castDrop.png" alt="castDrop.py">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/castDrop-1.png" alt="castDrop.py">
    <br>
    <!-- cve_monitor.py -->
        ...
        <br>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cve_monitor.png" alt="cve_monitor.py">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cve_monitor-t.png" alt="cve_monitor_bot">
    <br>
    <!-- Name_cleaner.sh / .py -->
        <a href="https://github.com/dsevillaprog/Shell-Scripts/" target="_blank"><img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;"
                src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script" title="Shell-Scripts"></a>
        ...
        <p>⠀⠀ ・Eliminando la numeración del principio</p>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Name_cleaner.png" alt="Name_cleaner help">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Name_cleaner.gif" alt="Name_cleaner">
    <br>
    <!-- logFilter.sh -->
        <a href="https://github.com/dsevillaprog/Shell-Scripts/" target="_blank"><img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;"
                src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script" title="Shell-Scripts"></a>
        ...
        <p>⠀⠀ ・Las añade a listas de baneo en función de los resultados</p>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/logFilter.png" alt="logFilter.sh">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/logFilter-1.png" alt="logFilter.sh">
    <br>
    <!-- curl_dump.sh -->
        <a href="https://github.com/dsevillaprog/Shell-Scripts/" target="_blank"><img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;"
                src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script" title="Shell-Scripts"></a>
        ...
        <br>
        <!--     <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/curl_dump.png" alt="curl_dump.sh"> -->
        <!--     <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/curl_dump-1.png" alt="curl_dump.sh"> -->
    <br>
    <!-- Media_converter.sh / .py -->
        ...
        <br>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Media_converter00.png" alt="Media_converter1">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Media_converter04.png" alt="Media_converter2">
    <br>
    <!-- DShtb.sh -->
        <a href="https://github.com/dsevillaprog/Shell-Scripts/" target="_blank"><img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;"
                src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script" title="Shell-Scripts"></a>
        ...
        <p> - Integra: nmap, dirb, ffuf, gobuster, nikto, nuclei, wpscan, sqlmap, smbclient, cewl, crunch,
            msfconsole, ...</p>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/DShtb.png" alt="DShtb.sh">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/DShtb_mx.png" alt="DShtb.sh mx">
    <br>
    <!-- img_convert.sh -->
        <img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script">
        ...
        <p> - Modifica metadatos con Exiftool.</p>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/img_convert.png" alt="img_convert1">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/img_convert2.png" alt="img_convert2">
    <br>
    <!-- Sed_loop-R.sh -->
        <a href="https://github.com/dsevillaprog/Shell-Scripts/" target="_blank"><img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;"
                src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script" title="Shell-Scripts"></a>
        ...
        <p>⠀⠀ ⠀ Cambiar dsevillaprog por RandomUser</p>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Sed_loop-R1.png" alt="Sed_lopp-R1">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Sed_loop-R2.png" alt="Sed_lopp-R2">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Sed_loop-R3.png" alt="Sed_lopp-R3">
        <br>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Sed_loop-R4.png" alt="Sed_lopp-R4">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Sed_loop-R5.png" alt="Sed_lopp-R5">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Sed_loop-R6.png" alt="Sed_lopp-R6">
    <br>
    <!-- Roli-Sounds .sh / .html -->
        <a href="https://github.com/dsevillaprog/Shell-Scripts/" target="_blank"><img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;"
                src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script" title="Shell-Scripts"></a>
        ...
        <p> - Crea/busca/modifica listas de estilos/cualidades.</p>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Roli-Sounds.gif" alt="Roli-Sounds">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Roli-Sounds.png" alt="Roli-Sounds.html">
    <br>
    <!-- VR-D2Pro Circuit Bending -->
        ...
        <br>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/vrd2pro.png" alt="VR-D2Pro Circuit Bending">
    <br>
    <!-- Casio SA-1 Circuit Bending -->
        ...
        <br>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/sa-1-in.jpg" alt="Casio SA-1">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/sa-1.jpg" alt="Casio SA-1 Circuit Bending">
    <!-- Alarma GSM - Arduino -->
        ...
        <p> - Monitoriza/Activa mediante sms y/o llamadas los sensores/actuadores conectados.</p>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/arduino-uno-top.jpg" alt="Arduino Uno">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/arduino-gsm.jpg" alt="Módulo SIM900">
    <br>
    <!-- Autotube.sh -->
        <a href="https://github.com/dsevillaprog/Shell-Scripts/" target="_blank"><img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;"
                src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script" title="Shell-Scripts"></a>
        ...
        <br>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/Autotube.png" alt="Autotube.sh">
    <br>
    <!-- USB PorCotilla -->
        <img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script">
        ...
        <p>⠀⠀ ・El proceso persistirá en cada reinicio hasta que el usuario cotilla elimine las claves de
            registro creadas</p>
        <br>
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/porcotilla-1.png" alt="porcotilla1">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/porcotilla-2.png" alt="porcotilla2">
            <img style="width: auto; max-height: 50vh; margin: 1%; border-radius: 6px;" src="../../../CURSO-CSS/blob/main/Ejercicio2/img/porcotilla-3.png" alt="porcotilla3">
    <br>
    <!-- BUSCADORES-WEB -->
        <a href="https://github.com/dsevillaprog/Shell-Scripts/" target="_blank"><img style="width: auto; max-height: 5vh; margin: 1%; border-radius: 6px;"
                src="../../../CURSO-CSS/blob/main/Ejercicio2/img/cmd.png" alt="Script" title="Shell-Scripts"></a>
